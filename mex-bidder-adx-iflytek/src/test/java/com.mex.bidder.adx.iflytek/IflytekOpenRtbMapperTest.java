 ...
 * Date: 2016/11/22
 */
public class IflytekOpenRtbMapperTest {
    IflytekOpenRtbMapper mapper = new IflytekOpenRtbMapper();
    ...
    public void toExchangeBidResponse() throws Exception {
        ...
        IflytekOpenRtbJsonFactory adviewOpenRtbJsonFactory = IflytekOpenRtbJsonFactory.create();
