 ...
 */
public class IflytekConnectionTypeMapper implements DictMapper<Integer,OpenRtb.ConnectionType> {

    public static final IflytekConnectionTypeMapper mapper = new IflytekConnectionTypeMapper();
